...
Version  : 1.3.0.post0
Release  : 15
URL      : https://files.pythonhosted.org/packages/94/36/45d139530abf9d53655225d9972f583a7b9e89733d87abc9a325e9697f2e/torchmetrics-1.3.0.post0.tar.gz
Source0  : https://files.pythonhosted.org/packages/94/36/45d139530abf9d53655225d9972f583a7b9e89733d87abc9a325e9697f2e/torchmetrics-1.3.0.post0.tar.gz
...
%prep
%setup -q -n torchmetrics-1.3.0.post0
cd %{_builddir}/torchmetrics-1.3.0.post0
pushd ..
cp -a torchmetrics-1.3.0.post0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705586438
