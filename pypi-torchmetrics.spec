...
Version  : 1.7.2
Release  : 36
URL      : https://github.com/Lightning-AI/torchmetrics/archive/v1.7.2/torchmetrics-1.7.2.tar.gz
Source0  : https://github.com/Lightning-AI/torchmetrics/archive/v1.7.2/torchmetrics-1.7.2.tar.gz
...
%prep
%setup -q -n torchmetrics-1.7.2
cd %{_builddir}/torchmetrics-1.7.2
pushd ..
cp -a torchmetrics-1.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748531198
