...
Version  : 1.7.4
Release  : 37
URL      : https://github.com/Lightning-AI/torchmetrics/archive/v1.7.4/torchmetrics-1.7.4.tar.gz
Source0  : https://github.com/Lightning-AI/torchmetrics/archive/v1.7.4/torchmetrics-1.7.4.tar.gz
...
%prep
%setup -q -n torchmetrics-1.7.4
cd %{_builddir}/torchmetrics-1.7.4
pushd ..
cp -a torchmetrics-1.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751901239
