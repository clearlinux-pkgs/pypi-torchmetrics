...
Version  : 1.4.1
Release  : 22
URL      : https://github.com/Lightning-AI/torchmetrics/archive/v1.4.1/torchmetrics-1.4.1.tar.gz
Source0  : https://github.com/Lightning-AI/torchmetrics/archive/v1.4.1/torchmetrics-1.4.1.tar.gz
...
%prep
%setup -q -n torchmetrics-1.4.1
cd %{_builddir}/torchmetrics-1.4.1
pushd ..
cp -a torchmetrics-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722873080
