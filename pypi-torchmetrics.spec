...
Source0  : https://github.com/Lightning-AI/torchmetrics/archive/v1.4.2/torchmetrics-1.4.2.tar.gz
...
%prep
%setup -q -n torchmetrics-1.4.2
cd %{_builddir}/torchmetrics-1.4.2
pushd ..
cp -a torchmetrics-1.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726267297
