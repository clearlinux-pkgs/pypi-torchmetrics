...
Version  : master
Release  : 16
URL      : https://github.com/Lightning-AI/torchmetrics/archive/master.zip
Source0  : https://github.com/Lightning-AI/torchmetrics/archive/master.zip
...
%prep
%setup -q -n torchmetrics-master
cd %{_builddir}/torchmetrics-master
pushd ..
cp -a torchmetrics-master buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706909557
